...
{
    double receiverFraction, argumentFraction;
    
    receiverFraction = (double ) self.numerator / self.denominator;
    argumentFraction = (double) theFraction.numerator / theFraction.denominator;
    
    if (receiverFraction > argumentFraction)
